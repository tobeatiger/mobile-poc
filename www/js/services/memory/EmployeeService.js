var EmployeeService = function(rootPath) {

    this.rootPath = rootPath ? rootPath : ''; // for unit test - corrected the image path
    ...
    // for unit test - corrected the image path
    var ctl = this;
    $.each(employees, function(index, epl) {
        epl.rootPath = ctl.rootPath;
    });
